...
local v2_low_ip = Address.ip("224.0.90.0")
local v2_high_ip = Address.ip("224.0.90.255")
...
local v0_high_ip = Address.ip("233.200.79.59")
...
local function is_v0(packet)
  ...
  if packet.dst < v0_low_ip or packet.dst > v0_high_ip then return false end
  return true
end
